...
let form = useForm({
       ...
       'days_stay': '',
       'person_number': '',
        'post_id': props.post ? props.post[0]?.id : null,
       'name': props.isStandard ? props.user.name : '',

})

 onMounted(() => {
   console.log('Selected Post:', props.post);
   console.log('Post ID:', props.post ? props.post[0]?.id : null);
  });
                    ...
                    <div class="p-6 ">
                        <form @submit.prevent="submit">
                            <div class="grid grid-cols-4 gap-4">
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="post_id" class="text-sm font-medium text-gray-900 block mb-2">Post</label>
                                     <input
                                        ...
                                        name="post_id"
                                        id="post_id"
                                        :value="props.post ? props.post[0]?.name : ''"
                                        readonly
                                        class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2.5"
                                        required
                                    />
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="days_stay" class="text-sm font-medium text-gray-900 block mb-2">Stay Duration</label>
                                ...
                                <div class="col-span-6 sm:col-span-2">
                                    <label for="person_number" class="text-sm font-medium text-gray-900 block mb-2">Person Quantity</label>
