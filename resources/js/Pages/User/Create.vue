    ...
    <Sidebar>
        ...
        <section class="container px-4 py-6 mx-auto">
            <div
                ...
                class="absolute top-20 right-1 p-4 bg-green-300 border border-gray-300 rounded-md shadow-md"
            >
            ...
            <div
                ...
                class="absolute top-20 right-1 p-4 bg-red-300 border border-gray-300 rounded-md shadow-md"
            >
            ...
            <div class="max-w-2xl mx-auto bg-white p-16">
                <div
                    class="block font-semibold text-xl self-start text-gray-700 mb-5"
                >
